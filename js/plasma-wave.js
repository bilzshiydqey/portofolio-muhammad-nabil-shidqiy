/* ============================================
   PLASMA WAVE HERO ANIMATION
   Ported from React PlasmaWave component
   into standalone vanilla JS using OGL.
   ============================================ */
...
(function () {
  ...
  const container = document.getElementById('plasma-wave-container');
  if (!container) return;
  ...
  const uniformOffset = new Float32Array([CONFIG.xOffset, CONFIG.yOffset]);
  ...
  const program = new Program(gl, {
    ...
    uniforms: {
      ...
      uRotation: { value: (CONFIG.rotationDeg * Math.PI) / 180 },
      uFocalLength: { value: CONFIG.focalLength },
      uSpeed1: { value: CONFIG.speed1 },
      uSpeed2: { value: CONFIG.speed2 },
      uDir2: { value: CONFIG.dir2 },
      uBend1: { value: CONFIG.bend1 },
